...
<head>
    <meta charset="utf-8"/>
    <title>مضيافي | تحويل للمستخدم</title>
        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper my-profile">
            ...
            <div class="m-subheader ">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="m-subheader__title ">تحويل لمزود الخدمة</h3>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="row ">
                                                    <div class="col-lg-6">
                                                        <div class="form-group m-form__group">
                                                            <label for="exampleSelect1">طريقة الدفع</label>
                                                            <select class="form-control m-input m-input--square " required id="exampleSelect1">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group m-form__group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" class="form-control m-input m-input--square" required placeholder="ادخل المبلغ" aria-describedby="basic-addon2">
                                                                <div class="input-group-append m-input--square"><span class="input-group-text" id="basic-addon2">ريال</span></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
