...
<head>
    <meta charset="utf-8"/>
    <title>مضيافي | عقارات مثبتة</title>
        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="m-subheader ">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="m-subheader__title ">العقارات المثبتة</h3>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>حمزة ابو عيطة</td>
                                    <td>المدينة</td>
                                    <td><span class="m-badge  m-badge--success m-badge--wide">متاح للحجز</span></td>
                                         ...
                                         <span class="dropdown user-option">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left user-option">
                                                <a class="dropdown-item" href="#m_modal_5" data-toggle="modal"
                                                 ...
                                                 <a class="dropdown-item" href="#m_modal_5" data-toggle="modal"
                                                    data-target="#m_modal_5"><i
                                                             class="la la-ban"></i> الغاء التثبيت  </a>
                                            </div>
                                        </span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>حمزة ابو عيطة</td>
                                    <td>المدينة</td>
                                    <td><span class="m-badge  m-badge--danger m-badge--wide">غير متاح</span></td>
