        ...
        <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
                <a href="#" class="m-menu__link m-menu__toggle">
                    <i class="m-menu__link-icon flaticon-graphic-2">
                    </i><span class="m-menu__link-text">احصائيات</span>
                </a>

            </li>
            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
                <a href="#" class="m-menu__link m-menu__toggle">
                    <i class="m-menu__link-icon flaticon-clipboard">
                    </i><span class="m-menu__link-text">تقارير</span>
                </a>
            ...
            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
                <a href="service-providers.php" class="m-menu__link m-menu__toggle">
                    <i class="m-menu__link-icon flaticon-computer">
                    </i><span class="m-menu__link-text">مزودي الخدمة</span>
                </a>
...
"></i><span class="m-menu__link-text">العروض</span><i
                        ...
                        <li class="m-menu__item " aria-haspopup="true">
                            <a href="offers.php"
                               class="m-menu__link "><i
                                        ...
                                        class="m-menu__link-text">العروض</span>
                            </a>
                        </li>
                        <li class="m-menu__item " aria-haspopup="true">
            ...
            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a
                        href="javascript:;" class="m-menu__link m-menu__toggle"><i
                            class="m-menu__link-icon la la-building"></i><span class="m-menu__link-text">عقارات</span><i
                            class="m-menu__ver-arrow la la-angle-right"></i></a>
                <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
                    <ul class="m-menu__subnav">
                        <li class="m-menu__item " aria-haspopup="true">
                            <a href="realestate.php"
                               class="m-menu__link "><i
                                        class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
                                        class="m-menu__link-text">عقارات</span>
                            </a>
                        </li>
                        <li class="m-menu__item " aria-haspopup="true">
                            <a href="realestate-fixed.php"
                               class="m-menu__link "><i
                                        class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span
                                        class="m-menu__link-text">العقارات المثبتة</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
                <a href="#" class="m-menu__link m-menu__toggle">
                    ...
                    </i><span class="m-menu__link-text">معاملات مالية</span>
                </a>
            ...
            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
                <a href="#" class="m-menu__link m-menu__toggle">
                    ...
                    </i><span class="m-menu__link-text">ثوابت</span>
                </a>
