...
<head>
    <meta charset="utf-8"/>
    <title>مضيافي | شكاوي مزودين الخدمات</title>
        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="m-subheader ">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="m-subheader__title ">شكاوي مزودي الخدمات</h3>
                    </div>
                </div>
            </div>
                    ...
                    <div class="m-portlet__body">
                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td><a href="#">حمزة ابو عيطة</a></td>
                                    <td>عنوان الشكوى</td>
                                    <td><span class="m-badge  m-badge--success m-badge--wide">يوجد رسائل</span></td>
                                    <td>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left user-option">
                                                <a class="dropdown-item" href="#m_modal_5" data-toggle="modal"
                                                   data-target="#m_modal_5"><i
                                                            class="la la-close"></i>اغلاق الشكوى </a>

                                            </div>
                                        </span>
                                    </td>
                                    <td>
                                        <a href="complaints-details.php"
                                ...
                                <tr>
                                    ...
                                    <td><a href="#">حمزة ابو عيطة</a></td>
                                    <td>عنوان الشكوى</td>
                                    <td><span class="m-badge  m-badge--danger m-badge--wide">لا يوجد رسائل</span></td>
                                    <td>
                                        <span class="dropdown">
                                            <a href="#"
                                               class="btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill"
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">اغلاق الشكوى</h5>
            ...
            <div class="modal-body">
                <p>
                    هل انت متأكد من اغلاق هذه الشكوى؟
                </p>
            </div>
